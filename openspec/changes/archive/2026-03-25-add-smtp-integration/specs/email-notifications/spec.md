...
- **WHEN** пользователь успешно регистрируется (POST /api/v1/auth/register возвращает 201)
...
- **WHEN** пользователь запрашивает сброс пароля (POST /api/v1/auth/password-reset/request)
